...
urlpatterns = [
    ...
    path('api/migrate_db/', views.api_migrate_db),
    ...
    path('api/get_works_with_error/', views.get_works_with_error),
    path('api/update_extrauser/', views.update_extrauser),
    path('api/infos_server/', views.infos_server),
    path('api/infos/', views.infos_server),
    ...
    path('api/sendmail/', views.api_sendmail),
