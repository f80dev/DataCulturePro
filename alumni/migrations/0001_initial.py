    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prizes', models.JSONField(help_text='Liste des prix', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Profil',
            fields=[
                ...
                ('cp', models.CharField(blank=True, help_text='code postal', max_length=5, null=True)),
                ...
                ('dtLastNotif', models.DateTimeField(default=datetime.datetime(2021, 1, 1, 0, 0), help_text='Date de la dernière notification envoyé')),
                ...
                ('advices', models.JSONField(default=None, help_text="Liste de conseils alimenter par l'outil pour augmenter le rayonnement d'une personne", null=True)),
